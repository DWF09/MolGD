"""Training MolGD with edges on QM9"""
...
def get_config():
    ...
    config.exp_type = 'vpsde_edge_cond_RL'
    config.RL_type = "multi"  #qed, sa, multi
    config.cond_RL = False
    config.new_train_set = 100000
    config.plus = 0.05
    config.std = 0.02
    config.eval_mean = [0.8, 0.8] #or [0.8, 0.8]
